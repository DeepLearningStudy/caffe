...
//        cout<<endl;
    ...
    caffe_rng_gaussian<Dtype>(nTestData/2*dim, mean_0, str_0, blob_test_data_->mutable_cpu_data());
    caffe_rng_gaussian<Dtype>(nTestData/2*dim, mean_1, str_1, blob_test_data_->mutable_cpu_data()+blob_test_data_->offset(nTestData/2,0,0,0));
